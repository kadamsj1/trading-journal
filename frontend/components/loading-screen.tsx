...
export function LoadingScreen({ message = "Initializing Terminal" }: { message?: string }) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] w-full space-y-8 animate-in fade-in duration-500">
