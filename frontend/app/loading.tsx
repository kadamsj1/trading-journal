...
export default function Loading() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full space-y-8 bg-background animate-in fade-in duration-1000">
            ...
            <div className="text-center space-y-2">
                <h2 className="text-2xl font-black italic tracking-tighter uppercase leading-none">Smart<span className="text-primary italic">Journal</span></h2>
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-50 pt-4">Professional Trading Intelligence</p>
            </div>
        </div>
    );
}
